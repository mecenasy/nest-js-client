...
import { messageSend, messageAll, messageById, messageRead } from './paths';
...
export const setReadMessage = async (messageId: string): Promise<AxiosResponse<any>> => {
  return await api.put(`${messageRead}/${messageId}`);
};