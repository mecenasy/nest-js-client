...
export const addMenuItemsRequest = createAction<MenuItemData & PromiseFParams>(
  'menu/addMenuItemsRequest',
);
...
export const { getMenuItemsSuccess, addMenuItemsSuccess, removeMenuItemsSuccess } =
